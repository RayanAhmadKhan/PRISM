...
const AdEnrollStudent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!rollNumber.trim())
      return setError("Please enter a student roll number.");
    ...
    try {
      ...
      const selectedCourse = courses.find((c) => c.courseCode === courseId);
      setSuccess(
        `Student "${rollNumber.trim()}" successfully enrolled in section "${sectionName}" of ${selectedCourse?.courseName}.`
      );
    ...
    <div className="p-3 md:p-5 flex flex-col gap-5">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-gray-400 text-sm">
          Add a student to a specific section within a course.
        </p>
      </div>
...
export default AdEnrollStudent;
