    ...
    <div className='min-h-dvh w-full'>
      ...
      <div className="body bg-zinc-900 flex">
        ...
        <div className="container h-screen flex flex-col items-start bg-zinc-800 w-full overflow-x-auto">
          <div className="header w-full flex flex-col sm:flex-row justify-between m-3 p-3 gap-3 sm:gap-5">
            ...
            <div className="actions flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="bg-zinc-900 p-1 border-2 border-gray-600 rounded-sm text-white w-full sm:w-auto"
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
              />
              <button className='bg-blue-700 p-1 w-full sm:w-45 font-bold rounded-sm cursor-pointer hover:bg-blue-900'>
                Download PDF Report
              </button>
            </div>
          </div>
          <div className="w-full p-2 md:p-5 overflow-x-auto">
            <Table
